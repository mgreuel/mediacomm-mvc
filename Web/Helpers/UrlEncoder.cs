...
namespace MediaCommMvc.Web.Helpers
{
    ...
    {
        /// <summary>
        /// see http://stackoverflow.com/questions/25259/how-does-stack-overflow-generate-its-seo-friendly-urls/25486#25486
        /// </summary>
        private static string RemoveIllegalCharactersFromUrl(string urlToEncode)
        {
            if (urlToEncode == null)
            {
                return "";
