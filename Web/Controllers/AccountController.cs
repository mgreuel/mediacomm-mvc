...
namespace MediaCommMvc.Web.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        public virtual async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            var result =
                await
                this.SignInManager.TwoFactorSignInAsync(model.Provider, model.Code, isPersistent: model.RememberMe, rememberBrowser: model.RememberBrowser);
            switch (result)
            {
                case SignInStatus.Success:
        ...
        public virtual async Task<ActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            return this.RedirectToAction("VerifyCode", new { Provider = model.SelectedProvider, ReturnUrl = model.ReturnUrl, model.RememberMe });
        }
